...
font = pygame.font.Font("nRLyO.ttf", 32)
...
lives_text = font.render("Lives: ", True, GREEN)
lives_text_rect = lives_text.get_rect()
lives_text_rect.topright = (WINDOW_WIDTH-50, 10)
...
player_image = pygame.image.load("forward.png")
player_rect = player_image.get_rect()
player_rect.left = 32
player_rect.centery = WINDOW_HEIGHT//2

coin_image = pygame.image.load("blood-drop.png")
