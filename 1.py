...
pygame.draw.line(displayscreen, RED, (0, WINDOW_HEIGHT//2), (WINDOW_WIDTH,WINDOW_HEIGHT//2), 3)
...
pygame.draw.line(displayscreen, GREEN, (0,WINDOW_HEIGHT), (WINDOW_WIDTH,0), 3)
...
#pygame.draw.rect(畫布名稱, 顏色, (topleft-x, topleft-y, width, height), thickness) 0:填滿, 1,2,3...10:線條寬度
